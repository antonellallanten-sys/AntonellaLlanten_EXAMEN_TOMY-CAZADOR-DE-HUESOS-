...
Descripción general:
TOMY CAZADOR DE HUESOS OP ART es un sistema interactivo en p5.js donde un perro debe recolectar huesos mientras esquiva glitches visuales. El sistema está compuesto por múltiples estados (inicio, juego, victoria y derrota) que modifican la lógica y comportamiento del entorno.
